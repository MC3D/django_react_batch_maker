...
# django-allauth configuration and custom user models
# https://django-allauth.readthedocs.io/en/latest/configuration.html#configuration
# https://django-allauth.readthedocs.io/en/latest/advanced.html?highlight=custom%20user%20models#custom-user-models
...
AUTHENTICATION_BACKENDS = (
    # Allows user to login by username in Django admin
    "django.contrib.auth.backends.ModelBackend",
    # `allauth` specific authentication method that allows user to login by e-mail
